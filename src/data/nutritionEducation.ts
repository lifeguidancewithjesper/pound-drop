...
export const nutritionEducation: EducationTopic[] = [
  // Macros Education
  {
    ...
    references: [
      'USDA FoodData Central - Protein nutrient data',
      'NIH Dietary Guidelines for Americans - Protein recommendations',
      'Academy of Nutrition and Dietetics - Protein and muscle preservation'
    ]
  },
  {
    id: 'carbs',
  ...
  },
  {
    ...
    references: [
      'USDA FoodData Central - Dietary fiber content',
      'NIH Dietary Guidelines - Fiber intake recommendations',
      'American Heart Association - Fiber and health benefits'
    ]
  },
  {
    id: 'hydration',
    ...
    references: [
      'NIH Dietary Guidelines - Hydration recommendations',
      'Academy of Nutrition and Dietetics - Water and weight management'
    ]
  },
