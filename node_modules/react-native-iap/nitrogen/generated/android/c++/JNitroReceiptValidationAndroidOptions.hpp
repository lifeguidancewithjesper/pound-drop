...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    static jni::local_ref<JNitroReceiptValidationAndroidOptions::javaobject> fromCpp(const NitroReceiptValidationAndroidOptions& value) {
      using JSignature = JNitroReceiptValidationAndroidOptions(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
